...
/**
 * Group management and browsing 
 */
qx.Class.define("aiagallery.module.dgallery.groups.Groups",
{
  type : "singleton",
  ...
  members :
  {
    ...
    initialAppear : function(module)
    {
      ...
      aiagallery.module.dgallery.groups.Fsm.getInstance().buildFsm(module);

      // Create the real gui.
      aiagallery.module.dgallery.groups.Gui.getInstance().buildGui(module);
    }
  }
});
