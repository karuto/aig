 ...
 * About gallery page 
 */
qx.Class.define("aiagallery.module.dgallery.about.About",
{
  type : "singleton",
  ...
  members :
  {
    ...
    initialAppear : function(module)
    {
      ...
      aiagallery.module.dgallery.about.Fsm.getInstance().buildFsm(module);

      // Create the real gui.
      aiagallery.module.dgallery.about.Gui.getInstance().buildGui(module);
    }
  }
});
