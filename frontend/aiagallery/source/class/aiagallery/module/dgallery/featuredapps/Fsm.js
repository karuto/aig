...
/**
 * Contest page Finite State Machine
 */
qx.Class.define("aiagallery.module.dgallery.featuredapps.Fsm",
{
  type : "singleton",
      ...
      state = new qx.util.fsm.State("State_Idle",
      {
        ...
        "onentry" : function(fsm, event)
        {
          ...
          if (fsm.getPreviousState() == "State_AwaitRpcResult")
          {
            ...
            var gui = aiagallery.module.dgallery.featuredapps.Gui.getInstance();
