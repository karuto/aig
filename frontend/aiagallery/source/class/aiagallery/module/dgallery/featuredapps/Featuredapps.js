 ...
 * Contest page 
 */
qx.Class.define("aiagallery.module.dgallery.featuredapps.Featuredapps",
{
  type : "singleton",
  ...
  members :
  {
    ...
    initialAppear : function(module)
    {
      ...
      aiagallery.module.dgallery.featuredapps.Fsm.getInstance().buildFsm(module);

      // Create the real gui.
      aiagallery.module.dgallery.featuredapps.Gui.getInstance().buildGui(module);
    }
  }
});
