...
/**
 * Gallery "Studios Management" Page
 */
qx.Class.define("aiagallery.module.dgallery.studiomanagement.StudioManagement",
{
  type : "singleton",
  ...
  members :
  {
    ...
    initialAppear : function(module)
    {
      ...
      aiagallery.module.dgallery.studiomanagement.Fsm.getInstance().buildFsm(module);

      // Create the real gui.
      aiagallery.module.dgallery.studiomanagement.Gui.getInstance().buildGui(module);
    }
  }
});
